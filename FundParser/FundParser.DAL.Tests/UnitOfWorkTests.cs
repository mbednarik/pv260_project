...
namespace FundParser.DAL.Tests
{
    ...
    public class UnitOfWorkTests
    {
        public class GetByIDTests : UnitOfWorkTestsBase
        {
            ...
            public async Task GetByID_NonExistingEntity_ThrowsException()
            {
                ...
                var result = Assert.ThrowsAsync<NotFoundException>(
                    async () => await unitOfWork.CompanyRepository.GetByID(0));
            ...
            public async Task GetByID_ExistingEntity_ReturnsCorrectEntity()
            {
                ...
                // Act
                var result = await unitOfWork.CompanyRepository.GetByID(expectedEntity.Id);
        ...
        public class InsertTests : UnitOfWorkTestsBase
        {
            [Test]
            ...
            [Test]
            public async Task Insert_CommitNotCalled_DoesNotInsertEntity()
            {
                // Arrange
                var expectedEntity = new Company
                {
                ...
                await unitOfWork.CompanyRepository.Insert(expectedEntity);
        ...
        public class DeleteTests : UnitOfWorkTestsBase
        {
            [Test]
            public void Delete_NonExistingEntity_ThrowsException()
            {
                // Act & Assert
                var result = Assert.ThrowsAsync<NotFoundException>(
                        async () => await unitOfWork.CompanyRepository.Delete(0));
                Assert.That(result.Message, Is.EqualTo("Entity with given Id does not exist."));
            }
            ...
            [Test]
            public async Task Delete_CommitNotCalled_DoesNotDeleteEntity()
            {
                // Arrange
                var expectedEntity = new Company
                {
                ...
                // Act
                unitOfWork.CompanyRepository.Delete(expectedEntity);
        ...
        public class UpdateTests : UnitOfWorkTestsBase
        {
            [Test]
            ...
            [Test]
            public async Task Update_CommitNotCalled_DoesNotUpdateEntity()
            {
                // Arrange
                var expectedEntity = new Company
                {
                ...
                // Act
                var newName = "newName";
                var updatedEntity = new Company
                {
                    Name = newName,
                    Cusip = CompanyCusip,
                    Ticker = CompanyTicker,
                };
                unitOfWork.CompanyRepository.Update(updatedEntity);
            ...
            public async Task Update_OneExistingEntity_UpdatesEntity()
            {
                ...
                unitOfWork.CompanyRepository.Update(expectedEntity);
                await unitOfWork.CommitAsync();
        ...
        public class GetAllTests : UnitOfWorkTestsBase
        {
            [Test]
            public async Task GetAll_EmptySet_ReturnsNoEntities()
            {
                // Act
                var result = await unitOfWork.CompanyRepository.GetAll();
            ...
            public async Task GetAll_NonEmptySet_ReturnsCorrectEntities()
            {
                ...
                // Act
                var result = (await unitOfWork.CompanyRepository.GetAll()).OrderBy(entity => entity.Id).ToList();
        ...
        public class GetQueryableTests : UnitOfWorkTestsBase
        {
            [Test]
            public void GetQueryable_EmptySet_ReturnsNoEntities()
            {
                // Act
                var result = unitOfWork.CompanyRepository.GetQueryable().ToList();
            ...
            public async Task GetQueryable_NonEmptySet_ReturnsCorrectEntities()
            {
                ...
                // Act
                var result = unitOfWork.CompanyRepository.GetQueryable().OrderBy(entity => entity.Id).ToList();
        ...
        public class UnitOfWorkTestsBase
        {
            ...
            public void Setup()
            {
                ...
                unitOfWork = new UnitOfWork.UnitOfWork(
                    context,
                    new Repository<Fund>(context),
                    new Repository<Company>(context),
                    new Repository<Holding>(context),
                    new Repository<HoldingDiff>(context)
                );
            }
